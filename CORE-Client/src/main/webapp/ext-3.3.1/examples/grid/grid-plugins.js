...
Ext.onReady(function(){
    ...
    var grid4 = new xg.GridPanel({
        ...
        cm: new xg.ColumnModel([
            ...
            {header: "Last Updated", width: 20, sortable: true, renderer: Ext.util.Format.dateRenderer('m/d/Y'), dataIndex: 'lastChange'},
			sm2,
			{header: 'action', width: 20, sortable: true, renderer: function(val){ return '<input type="button" onclick="editBtnClick(\''+ val +'\');" value="Edit" id="'+val+'"/>'; }, dataIndex: 'company'}
        ...
        tbar:[{
			...
			handler : function(){
				...
				for(var i = 0, len = selections.length; i < len; i++){        		
					var ss = "{\"id\":\"" + selections[i].get("company") + "\"}";
					//alert(ss);
					if(i==0)
