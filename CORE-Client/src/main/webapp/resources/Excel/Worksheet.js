	...
	setSharedStringCollection: function (stringCollection) {
        ...
        */
        ...
        toXML: function () {
            ...
            if (this.pageSetUpPr.length > 0) {
                var sheetPr = doc.createElement('sheetPr');
                var pageSetUpPr = doc.createElement('pageSetUpPr');
                for (var i = 0, l = this.pageSetUpPr.length; i < l; i++) {
                    pageSetUpPr.setAttribute(this.pageSetUpPr[i].name, this.pageSetUpPr[i].value);
                }
            ...
            for(var row = 0, l = data.length; row < l; row++) {
                ...
                if(rows[row]){
                    rowNode.setAttribute('ht', rows[row].height);
            ...
            if (this.pageSetup.length > 0) {
                var pageSetup = doc.createElement('pageSetup');
                for (var i = 0, l = this.pageSetup.length; i < l; i++) {
                    pageSetup.setAttribute(this.pageSetup[i].name, this.pageSetup[i].value);
                }
        ...
        /**
         * Expects an array of row definitions. Each column definition needs to have a height assigned to it. 
         * 
         * @param {Array} rows
         */
        ...
        setPageSetUpPr: function (pageSetUpPr) {
