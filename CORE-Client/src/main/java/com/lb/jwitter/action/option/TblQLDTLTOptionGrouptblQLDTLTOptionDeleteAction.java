...
public class TblQLDTLTOptionGrouptblQLDTLTOptionDeleteAction{
...
tblQuyenChiTietService = (TblQuyenChiTietService) context.getBean("tbl_Quyen_ChiTietClient"); 
     if(!tblQuyenChiTietService.checkRight(taiKhoanDangNhap.getMaNhomQuyen().getId(), "tbl_QLDTLT_Option", "xoa")){ 
        return "noprivilege"; 
    ...
    tblQLDTLTOptionService.deleteListTblQLDTLTOption(ids); 
        return Action.SUCCESS; 
      } 
      catch(Exception e){ 
      System.out.println("Loi Delete tbl_QLDTLT_Option Action"); 
     e.printStackTrace(); 
