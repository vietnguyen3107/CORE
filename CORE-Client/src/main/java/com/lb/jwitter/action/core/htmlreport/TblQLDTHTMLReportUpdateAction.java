...
public class TblQLDTHTMLReportUpdateAction{
    ...
    public void setTblQLDTHTMLReport (TblQLDTHTMLReport tblQLDTHTMLReport) {
        this.tblQLDTHTMLReport = tblQLDTHTMLReport;
 }

    private List<TblQLDTHTMLReport> tblQLDTHTMLReports; 
    public void setTblQLDTHTMLReports(List<TblQLDTHTMLReport> tblQLDTHTMLReports) {
        this.tblQLDTHTMLReports = tblQLDTHTMLReports; 
      } 

    private TblQLDTHTMLReportService tblQLDTHTMLReportService; 

	private int preUpdate(Message msg, TblQLDTHTMLReport obj ){ 
        msg.setPreMessage_b(true); 
        msg.setPreMessage_s("success"); 
        return 1; 
    } 
	private int postUpdate(Message msg, TblQLDTHTMLReport obj ){ 
 ...
 private TblQuyenChiTietService tblQuyenChiTietService;
   ...
   { 
    ...
    if(!tblQuyenChiTietService.checkRight(taiKhoanDangNhap.getMaNhomQuyen().getId(), "tbl_QLDT_HTMLReport", "sua")){ 
        ...
        preUpdate(msg,tblQLDTHTMLReport); 
       ...
       { 
           tblQLDTHTMLReportService.updateTblQLDTHTMLReport(tblQLDTHTMLReport); 
           postUpdate(msg, tblQLDTHTMLReport); 
        ...
        return Action.SUCCESS; 
         ...
         System.out.println("Loi Update tbl_QLDT_HTMLReport Action"); 
         e.printStackTrace(); 
