...
public class TblQLDTHTMLReporttblQLDTHTMLReportParamInsertAction{
	...
	private int preInsert(Message msg, TblQLDTHTMLReportParam obj ){ 
        msg.setPreMessage_b(true); 
        msg.setPreMessage_s("success"); 
        return 1; 
    } 
	private int postInsert(Message msg, TblQLDTHTMLReportParam obj ){ 
 ...
 private TblQuyenChiTietService tblQuyenChiTietService;
   ...
   { 
    ...
    if(!tblQuyenChiTietService.checkRight(taiKhoanDangNhap.getMaNhomQuyen().getId(), "tbl_QLDT_HTMLReport_Param", "them")){ 
        return "noprivilege"; 
    }
        ...
        msg = new Message(); 
        tblQLDTHTMLReportParam = new TblQLDTHTMLReportParam(); 
        preInsert(msg,tblQLDTHTMLReportParam); 
        TblQLDTHTMLReport iTblQLDTHTMLReport = new TblQLDTHTMLReport(); 
        iTblQLDTHTMLReport.setId(new Long(reportId));  
        tblQLDTHTMLReportParam.setReportId(reportId <=0 ? null : iTblQLDTHTMLReport );  
       ...
       { 
           tblQLDTHTMLReportParamService.createTblQLDTHTMLReportParam(tblQLDTHTMLReportParam); 
           postInsert(msg, tblQLDTHTMLReportParam); 
      ...
      dataStringTblQLDTHTMLReportParam += "&paramVariable="; 
        return Action.SUCCESS; 
         ...
         System.out.println("Loi Insert tbl_QLDT_HTMLReport_Param Action"); 
         e.printStackTrace(); 
